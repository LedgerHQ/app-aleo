...
cx_err_t sys_cx_bn_mod_add(cx_bn_t bn_r, const cx_bn_t bn_a, const cx_bn_t bn_b, const cx_bn_t bn_m)
{
    cx_err_t  error;
    cx_mpi_t *r, *a, *b, *m;
...
cx_err_t sys_cx_bn_mod_sub(cx_bn_t bn_r, const cx_bn_t bn_a, const cx_bn_t bn_b, const cx_bn_t bn_m)
{
    cx_err_t  error;
    cx_mpi_t *r, *a, *b, *m;
...
cx_err_t sys_cx_bn_mod_mul(cx_bn_t bn_r, const cx_bn_t bn_a, const cx_bn_t bn_b, const cx_bn_t bn_m)
{
    cx_err_t  error;
    cx_mpi_t *r, *a, *b, *m;
...
cx_err_t sys_cx_bn_gf2_n_mul(cx_bn_t       bn_r,
                             const cx_bn_t bn_a,
                             const cx_bn_t bn_b,
                             const cx_bn_t bn_n,
                             const cx_bn_t bn_h)
