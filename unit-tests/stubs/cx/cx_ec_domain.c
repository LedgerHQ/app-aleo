...
static uint8_t const C_cx_secp521r1_Hn[] = {
    // Hn:
    0x01, 0xbc, 0xcf, 0xf3, 0xd1, 0x42, 0xb7, 0x75, 0x6e, 0x3e, 0xdd, 0x6e, 0x23, 0xd8,
    0x2e, 0x49, 0xc7, 0xdc, 0x81, 0x3d, 0x00, 0xeb, 0xc5, 0x45, 0x05, 0x9b, 0x80, 0x5c,
    0xc3, 0x49, 0x42, 0x90, 0xa7, 0xc8, 0x18, 0x47, 0x42, 0xd7, 0x00, 0xe0, 0x81, 0x09,
    0x4e, 0x89, 0x3c, 0x9c, 0xf6, 0x52, 0x22, 0x7d, 0x46, 0x5b, 0x9f, 0x72, 0x66, 0xb4,
    0x7e, 0xe7, 0xf0, 0x56, 0x21, 0x96, 0x51, 0x92, 0x0b, 0xb5};
...
static uint8_t const C_cx_BrainpoolP320r1_Hp[] = {
    0x40, 0x3a, 0x05, 0x6e, 0x97, 0xa2, 0xc0, 0x9c, 0xdb, 0xc2, 0x1a, 0x81, 0x77, 0x27,
    0xa6, 0xd4, 0xc5, 0x3a, 0xa9, 0x67, 0x5c, 0x40, 0x00, 0xf4, 0x10, 0x26, 0x0b, 0x24,
    0xef, 0x82, 0x14, 0x48, 0xb4, 0xe0, 0x40, 0x50, 0xad, 0x8b, 0x40, 0x0d,
};
...
static uint8_t const C_cx_BrainpoolP320r1_Hn[] = {
    0xa7, 0x0d, 0x3d, 0xb6, 0xd2, 0x66, 0x8a, 0x95, 0x3b, 0x53, 0x96, 0xfe, 0xb0, 0x0b,
    0x95, 0x14, 0x07, 0xad, 0x16, 0x66, 0x45, 0x8b, 0xcc, 0x15, 0xdd, 0x86, 0x02, 0x95,
    0xe4, 0xa3, 0xf1, 0xa0, 0xb9, 0xb6, 0xac, 0x1d, 0x66, 0x16, 0x3f, 0x17,
...
static uint8_t const C_cx_BrainpoolP320t1_a[] = {
    ...
    0xD3, 0x5E, 0x47, 0x20, 0x36, 0xBC, 0x4F, 0xB7, 0xE1, 0x3C, 0x78, 0x5E, 0xD2, 0x01,
    0xE0, 0x65, 0xF9, 0x8F, 0xCF, 0xA6, 0xF6, 0xF4, 0x0D, 0xEF, 0x4F, 0x92, 0xB9, 0xEC,
    0x78, 0x93, 0xEC, 0x28, 0xFC, 0xD4, 0x12, 0xB1, 0xF1, 0xB3, 0x2E, 0x24};
static uint8_t const C_cx_BrainpoolP320t1_b[] = {
    ...
    0xA7, 0xF5, 0x61, 0xE0, 0x38, 0xEB, 0x1E, 0xD5, 0x60, 0xB3, 0xD1, 0x47, 0xDB, 0x78,
    0x20, 0x13, 0x06, 0x4C, 0x19, 0xF2, 0x7E, 0xD2, 0x7C, 0x67, 0x80, 0xAA, 0xF7, 0x7F,
    0xB8, 0xA5, 0x47, 0xCE, 0xB5, 0xB4, 0xFE, 0xF4, 0x22, 0x34, 0x03, 0x53};
...
static uint8_t const C_cx_BrainpoolP320t1_Gx[] = {
    ...
    0x92, 0x5B, 0xE9, 0xFB, 0x01, 0xAF, 0xC6, 0xFB, 0x4D, 0x3E, 0x7D, 0x49, 0x90, 0x01,
    0x0F, 0x81, 0x34, 0x08, 0xAB, 0x10, 0x6C, 0x4F, 0x09, 0xCB, 0x7E, 0xE0, 0x78, 0x68,
    0xCC, 0x13, 0x6F, 0xFF, 0x33, 0x57, 0xF6, 0x24, 0xA2, 0x1B, 0xED, 0x52};
static uint8_t const C_cx_BrainpoolP320t1_Gy[] = {
    ...
    0x63, 0xBA, 0x3A, 0x7A, 0x27, 0x48, 0x3E, 0xBF, 0x66, 0x71, 0xDB, 0xEF, 0x7A, 0xBB,
    0x30, 0xEB, 0xEE, 0x08, 0x4E, 0x58, 0xA0, 0xB0, 0x77, 0xAD, 0x42, 0xA5, 0xA0, 0x98,
    0x9D, 0x1E, 0xE7, 0x1B, 0x1B, 0x9B, 0xC0, 0x45, 0x5F, 0xB0, 0xD2, 0xC3};
...
static uint8_t const C_cx_Stark256_Hp[] = {
    ...
    0x07, 0xff, 0xd4, 0xab, 0x5e, 0x00, 0x88, 0x10, 0xff, 0xff, 0xff, 0xff, 0xff, 0x6f, 0x80, 0x00,
    0x00, 0x00, 0x00, 0x01, 0x33, 0x0f, 0xff, 0xff, 0xff, 0xff, 0xfd, 0x73, 0x7e, 0x00, 0x04, 0x01};
...
static uint8_t const C_cx_Stark256_Hn[] = {
    ...
    0x07, 0xd9, 0xe5, 0x7c, 0x23, 0x33, 0x76, 0x6e, 0xba, 0xf0, 0xab, 0x4c, 0xf7, 0x8b, 0xba, 0xbb,
    0x50, 0x9c, 0xf6, 0x4d, 0x14, 0xce, 0x60, 0xb9, 0x60, 0x21, 0xb3, 0xf1, 0xea, 0x1c, 0x68, 0x8d};
...
static uint8_t const C_cx_BLS12_381_G1_Hp[BLS12_381_SIZE_u8] = {
    0x11, 0x98, 0x8f, 0xe5, 0x92, 0xca, 0xe3, 0xaa, 0x9a, 0x79, 0x3e, 0x85, 0xb5, 0x19, 0x95, 0x2d,
    0x67, 0xeb, 0x88, 0xa9, 0x93, 0x9d, 0x83, 0xc0, 0x8d, 0xe5, 0x47, 0x6c, 0x4c, 0x95, 0xb6, 0xd5,
    0x0a, 0x76, 0xe6, 0xa6, 0x09, 0xd1, 0x04, 0xf1, 0xf4, 0xdf, 0x1f, 0x34, 0x1c, 0x34, 0x17, 0x46};
...
static uint8_t const C_cx_BLS12_381_G1_Hn[BLS12_381_SIZE_u8] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x6e, 0x2a, 0x5b, 0xb9, 0xc8, 0xdb, 0x33, 0xe9, 0x73, 0xd1, 0x3c, 0x71, 0xc7, 0xb5, 0xf4, 0x18,
    0x1b, 0x3e, 0x0d, 0x18, 0x8c, 0xf0, 0x69, 0x90, 0xc6, 0x2c, 0x18, 0x07, 0x43, 0x9b, 0x73, 0xaf};
...
cx_curve_weierstrass_t const C_cx_BLS12_381_G1 = {.curve    = CX_CURVE_BLS12_381_G1,
                                                  .bit_size = 381,
...
static uint8_t const C_cx_BLS12_377_G1_p[BLS12_377_SIZE_u8] = {
    0x01, 0xae, 0x3a, 0x46, 0x17, 0xc5, 0x10, 0xea, 0xc6, 0x3b, 0x05, 0xc0, 0x6c, 0xa1, 0x49, 0x3b,
    0x1a, 0x22, 0xd9, 0xf3, 0x00, 0xf5, 0x13, 0x8f, 0x1e, 0xf3, 0x62, 0x2f, 0xba, 0x09, 0x48, 0x00,
    0x17, 0x0b, 0x5d, 0x44, 0x30, 0x00, 0x00, 0x00, 0x85, 0x08, 0xc0, 0x00, 0x00, 0x00, 0x00, 0x01};
...
static uint8_t const C_cx_BLS12_377_G1_Hp[BLS12_377_SIZE_u8] = {
    0x00, 0x6d, 0xfc, 0xcb, 0x1e, 0x91, 0x4b, 0x88, 0x83, 0x7e, 0x92, 0xf0, 0x41, 0x79, 0x0b, 0xf9,
    0xbf, 0xdf, 0x7d, 0x03, 0x82, 0x7d, 0xc3, 0xac, 0x22, 0xa5, 0xf1, 0x11, 0x62, 0xd6, 0xb4, 0x6d,
    0x03, 0x29, 0xfc, 0xaa, 0xb0, 0x04, 0x31, 0xb1, 0xb7, 0x86, 0x68, 0x6c, 0x94, 0x00, 0xcd, 0x22};
...
static uint8_t const C_cx_BLS12_377_G1_n[BLS12_377_SIZE_u8] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x12, 0xab, 0x65, 0x5e, 0x9a, 0x2c, 0xa5, 0x56, 0x60, 0xb4, 0x4d, 0x1e, 0x5c, 0x37, 0xb0, 0x01,
    0x59, 0xaa, 0x76, 0xfe, 0xd0, 0x00, 0x00, 0x01, 0x0a, 0x11, 0x80, 0x00, 0x00, 0x00, 0x00, 0x01};
static uint8_t const C_cx_BLS12_377_G1_Hn[BLS12_377_SIZE_u8] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x06, 0x01, 0xdf, 0xa5, 0x55, 0xc4, 0x8d, 0xda, 0xb1, 0xe5, 0x5e, 0xf6, 0xf1, 0xc9, 0xd7, 0x13,
    0x62, 0x4d, 0x23, 0xff, 0xae, 0x27, 0x16, 0x99, 0x6a, 0x42, 0x95, 0xc9, 0x0f, 0x65, 0x45, 0x4c};
static uint8_t const C_cx_BLS12_377_G1_Gx[BLS12_377_SIZE_u8] = {
    0x00, 0x88, 0x48, 0xde, 0xfe, 0x74, 0x0a, 0x67, 0xc8, 0xfc, 0x62, 0x25, 0xbf, 0x87, 0xff, 0x54,
    0x85, 0x95, 0x1e, 0x2c, 0xaa, 0x9d, 0x41, 0xbb, 0x18, 0x82, 0x82, 0xc8, 0xbd, 0x37, 0xcb, 0x5c,
    0xd5, 0x48, 0x15, 0x12, 0xff, 0xcd, 0x39, 0x4e, 0xea, 0xb9, 0xb1, 0x6e, 0xb2, 0x1b, 0xe9, 0xef};
static uint8_t const C_cx_BLS12_377_G1_Gy[BLS12_377_SIZE_u8] = {
    0x01, 0x91, 0x4a, 0x69, 0xc5, 0x10, 0x2e, 0xff, 0x1f, 0x67, 0x4f, 0x5d, 0x30, 0xaf, 0xee, 0xc4,
    0xbd, 0x7f, 0xb3, 0x48, 0xca, 0x3e, 0x52, 0xd9, 0x6d, 0x18, 0x2a, 0xd4, 0x4f, 0xb8, 0x23, 0x05,
    0xc2, 0xfe, 0x3d, 0x36, 0x34, 0xa9, 0x59, 0x1a, 0xfd, 0x82, 0xde, 0x55, 0x55, 0x9c, 0x8e, 0xa6};

static uint8_t const C_cx_BLS12_377_G1_h[BLS12_377_SIZE_u8] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x17, 0x0b, 0x5d, 0x44, 0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};

cx_curve_weierstrass_t const C_cx_BLS12_377_G1 = {.curve    = CX_CURVE_BLS12_377_G1,
                                                  .bit_size = 377,
...
static uint8_t const C_cx_Pallas_Hp[PASTA_SIZE_u8] = {
    ...
    // p
    0x09, 0x6d, 0x41, 0xaf, 0x7b, 0x9c, 0xb7, 0x14, 0x77, 0x97, 0xa9, 0x9b, 0xc3, 0xc9, 0x5d, 0x18,
    0xd7, 0xd3, 0x0d, 0xbd, 0x8b, 0x0d, 0xe0, 0xe7, 0x8c, 0x78, 0xec, 0xb3, 0x00, 0x00, 0x00, 0x0f};
static uint8_t const C_cx_Pallas_Gx[PASTA_SIZE_u8] = {
    // Gx:
    // 0x14733b283272574e23931f358a0354b7bcd5c765cc1fceacc3b3d1a0c495c9e
    0x01, 0x47, 0x33, 0xb2, 0x83, 0x27, 0x25, 0x74, 0xe2, 0x39, 0x31, 0xf3, 0x58, 0xa0, 0x35, 0x4b,
    0x7b, 0xcd, 0x5c, 0x76, 0x5c, 0xc1, 0xfc, 0xea, 0xcc, 0x3b, 0x3d, 0x1a, 0x0c, 0x49, 0x5c, 0x9e};
static uint8_t const C_cx_Pallas_Gy[PASTA_SIZE_u8] = {
    // Gy:
    // 0x3a7b895f5e1fa91d826f72ea26b5c90b1bae77d129f5ecc1378924d743f4b678
    0x3a, 0x7b, 0x89, 0x5f, 0x5e, 0x1f, 0xa9, 0x1d, 0x82, 0x6f, 0x72, 0xea, 0x26, 0xb5, 0xc9, 0x0b,
    0x1b, 0xae, 0x77, 0xd1, 0x29, 0xf5, 0xec, 0xc1, 0x37, 0x89, 0x24, 0xd7, 0x43, 0xf4, 0xb6, 0x78};
...
static uint8_t const C_cx_Pallas_Hn[PASTA_SIZE_u8] = {
    ...
    // n
    0x09, 0x6d, 0x41, 0xaf, 0x7c, 0xcf, 0xda, 0xa9, 0x7f, 0xae, 0x23, 0x10, 0x04, 0xcc, 0xf5, 0x90,
    0x67, 0xbb, 0x43, 0x3d, 0x89, 0x1a, 0x16, 0xe3, 0xfc, 0x96, 0x78, 0xff, 0x00, 0x00, 0x00, 0x0f};
...
static uint8_t const C_cx_Vesta_Gx[PASTA_SIZE_u8] = {
    ...
    0x2d, 0x39, 0x96, 0xe1, 0x8f, 0x13, 0x4b, 0xd9, 0x3a, 0xec, 0x73, 0xc9, 0xb9, 0x84, 0xdb, 0Xf2,
    0x70, 0x74, 0xe5, 0x44, 0x02, 0x9e, 0x4a, 0xc1, 0x22, 0xfb, 0x21, 0x9f, 0xde, 0x2b, 0x20, 0Xeb};
static uint8_t const C_cx_Vesta_Gy[PASTA_SIZE_u8] = {
    // Gy:
    // 0x2afaa43f3c902b3d19adc0b90aa1e9a37d55c73d7753f722f34d456e530854f0
    0x2a, 0xfa, 0xa4, 0x3f, 0x3c, 0x90, 0x2b, 0x3d, 0x19, 0xad, 0xc0, 0xb9, 0x0a, 0xa1, 0xe9, 0xa3,
    0x7d, 0x55, 0xc7, 0x3d, 0x77, 0x53, 0xf7, 0x22, 0xf3, 0x4d, 0x45, 0x6e, 0x53, 0x08, 0x54, 0xf0};
...
static uint8_t const C_cx_Ed448_d[] = {
    ...
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x67, 0x56};
...
static uint8_t const C_cx_Ed448_Bx[] = {
    ...
    0x00, 0x4f, 0x19, 0x70, 0xc6, 0x6b, 0xed, 0x0d, 0xed, 0x22, 0x1d, 0x15, 0xa6, 0x22, 0xbf,
    0x36, 0xda, 0x9e, 0x14, 0x65, 0x70, 0x47, 0x0f, 0x17, 0x67, 0xea, 0x6d, 0xe3, 0x24, 0xa3,
    0xd3, 0xa4, 0x64, 0x12, 0xae, 0x1a, 0xf7, 0x2a, 0xb6, 0x65, 0x11, 0x43, 0x3b, 0x80, 0xe1,
    0x8b, 0x00, 0x93, 0x8e, 0x26, 0x26, 0xa8, 0x2b, 0xc7, 0x0c, 0xc0, 0x5e};
static uint8_t const C_cx_Ed448_By[] = {
    ...
    0x00, 0x69, 0x3f, 0x46, 0x71, 0x6e, 0xb6, 0xbc, 0x24, 0x88, 0x76, 0x20, 0x37, 0x56, 0xc9,
    0xc7, 0x62, 0x4b, 0xea, 0x73, 0x73, 0x6c, 0xa3, 0x98, 0x40, 0x87, 0x78, 0x9c, 0x1e, 0x05,
    0xa0, 0xc2, 0xd7, 0x3a, 0xd3, 0xff, 0x1c, 0xe6, 0x7c, 0x39, 0xc4, 0xfd, 0xbd, 0x13, 0x2c,
    0x4e, 0xd7, 0xc8, 0xad, 0x98, 0x08, 0x79, 0x5b, 0xf2, 0x30, 0xfa, 0x14};
...
static uint8_t const C_cx_Ed448_Hl[] = {
    // Hl:
    0x00, 0x1a, 0x9c, 0xc1, 0x4b, 0xa3, 0xc4, 0x7c, 0x44, 0xae, 0x17, 0xcf, 0x72, 0xc9, 0x86,
    0x0f, 0xaa, 0x10, 0x75, 0x50, 0xba, 0x94, 0xd0, 0xe8, 0x08, 0xf1, 0x0a, 0x98, 0xef, 0x88,
    0xe1, 0x5b, 0xb4, 0x8b, 0xd8, 0x27, 0xde, 0x12, 0x7c, 0xe5, 0xf2, 0x3e, 0x0a, 0xa6, 0x8d,
    0x30, 0xdb, 0xb9, 0x89, 0xbb, 0xec, 0xff, 0xc3, 0x3c, 0x3a, 0x37, 0x8c};
...
static uint8_t const C_cx_EdBLS12_Hq[EDBLS12_377_SIZE_u8] = {
    ...
    0x01, 0x1f, 0xda, 0xe7, 0xef, 0xf1, 0xc9, 0x39, 0xa7, 0xcc, 0x00, 0x8f, 0xe5, 0xdc, 0x85, 0x93,
    0xcc, 0x2c, 0x27, 0xb5, 0x88, 0x60, 0x59, 0x1f, 0x25, 0xd5, 0x77, 0xba, 0xb8, 0x61, 0x85, 0x7b};
static uint8_t const C_cx_EdBLS12_Gx[EDBLS12_377_SIZE_u8] = {
    ...
    0x09, 0xf1, 0xb5, 0xa5, 0xba, 0xf6, 0xac, 0xf0, 0x6f, 0xed, 0x91, 0xc9, 0xae, 0x9e, 0xbf, 0xa0,
    0x60, 0x68, 0xdd, 0x28, 0x35, 0x79, 0x09, 0x80, 0x89, 0x4e, 0x23, 0x28, 0xf3, 0xeb, 0xca, 0x05};
static uint8_t const C_cx_EdBLS12_Gy[EDBLS12_377_SIZE_u8] = {
    ...
    0x09, 0xa2, 0x0d, 0xf3, 0x65, 0x71, 0xac, 0x3c, 0xd9, 0x06, 0xb2, 0x56, 0x08, 0x0b, 0xa8, 0x45,
    0x44, 0x53, 0xc1, 0x77, 0xaa, 0xf3, 0x13, 0x1b, 0xb5, 0x0a, 0x67, 0xbf, 0x1a, 0x80, 0x67, 0x81};
static uint8_t const C_cx_EdBLS12_n[EDBLS12_377_SIZE_u8] = {
    // 0x4aad957a68b2955982d1347970dec005293a3afc43c8afeb95aee9ac33fd9ff
    0x04, 0xaa, 0xd9, 0x57, 0xa6, 0x8b, 0x29, 0x55, 0x98, 0x2d, 0x13, 0x47, 0x97, 0x0d, 0xec, 0x00,
    0x52, 0x93, 0xa3, 0xaf, 0xc4, 0x3c, 0x8a, 0xfe, 0xb9, 0x5a, 0xee, 0x9a, 0xc3, 0x3f, 0xd9, 0xff};
static uint8_t const C_cx_EdBLS12_Hn[EDBLS12_377_SIZE_u8] = {
    ...
    0x47, 0xad, 0xa1, 0xee, 0xf0, 0x2d, 0x84, 0x1c, 0xa0, 0x60, 0x49, 0xcc, 0xd0, 0x27, 0xa2, 0x1f,
    0x63, 0x9c, 0x3f, 0x57, 0xa7, 0x3d, 0xa7, 0x33, 0x75, 0x69, 0x9c, 0xd6, 0xa5, 0x5d, 0x45, 0xe};
...
static uint8_t const C_cx_Jubjub_Hq[PASTA_SIZE_u8] = {
    ...
    0x07, 0x48, 0xd9, 0xd9, 0x9f, 0x59, 0xff, 0x11, 0x05, 0xd3, 0x14, 0x96, 0x72, 0x54, 0x39, 0x8f,
    0x2b, 0x6c, 0xed, 0xcb, 0x87, 0x92, 0x5c, 0x23, 0xc9, 0x99, 0xe9, 0x90, 0xf3, 0xf2, 0x9c, 0x6d};
static uint8_t const C_cx_Jubjub_Gx[PASTA_SIZE_u8] = {
    // 0x11dafe5d23e1218086a365b99fbf3d3be72f6afd7d1f72623e6b071492d1122b
    0x11, 0xda, 0xfe, 0x5d, 0x23, 0xe1, 0x21, 0x80, 0x86, 0xa3, 0x65, 0xb9, 0x9f, 0xbf, 0x3d, 0x3b,
    0xe7, 0x2f, 0x6a, 0xfd, 0x7d, 0x1f, 0x72, 0x62, 0x3e, 0x6b, 0x07, 0x14, 0x92, 0xd1, 0x12, 0x2b};
static uint8_t const C_cx_Jubjub_Gy[PASTA_SIZE_u8] = {
    // 0x1d523cf1ddab1a1793132e78c866c0c33e26ba5cc220fed7cc3f870e59d292aa
    0x1d, 0x52, 0x3c, 0xf1, 0xdd, 0xab, 0x1a, 0x17, 0x93, 0x13, 0x2e, 0x78, 0xc8, 0x66, 0xc0, 0xc3,
    0x3e, 0x26, 0xba, 0x5c, 0xc2, 0x20, 0xfe, 0xd7, 0xcc, 0x3f, 0x87, 0x0e, 0x59, 0xd2, 0x92, 0xaa};
...
static uint8_t const C_cx_Jubjub_Hn[PASTA_SIZE_u8] = {
    ...
    0x04, 0xf6, 0x54, 0x7b, 0x8d, 0x12, 0x76, 0x88, 0x69, 0xda, 0xb7, 0xfa, 0xc0, 0x26, 0xe9, 0xa5,
    0x51, 0xb0, 0xce, 0xf0, 0x9c, 0xe3, 0xfc, 0x26, 0x67, 0x71, 0x9a, 0xa4, 0x95, 0xe5, 0x77, 0x31};
...
static uint8_t const C_cx_Curve448_a[] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x62, 0xa6};
...
static uint8_t const C_cx_Curve448_Hn[] = {
    // Hn:
    0x1a, 0x9c, 0xc1, 0x4b, 0xa3, 0xc4, 0x7c, 0x44, 0xae, 0x17, 0xcf, 0x72, 0xc9, 0x86,
    0x0f, 0xaa, 0x10, 0x75, 0x50, 0xba, 0x94, 0xd0, 0xe8, 0x08, 0xf1, 0x0a, 0x98, 0xef,
    0x88, 0xe1, 0x5b, 0xb4, 0x8b, 0xd8, 0x27, 0xde, 0x12, 0x7c, 0xe5, 0xf2, 0x3e, 0x0a,
    0xa6, 0x8d, 0x30, 0xdb, 0xb9, 0x89, 0xbb, 0xec, 0xff, 0xc3, 0x3c, 0x3a, 0x37, 0x8c};
...
cx_err_t sys_cx_ecdomain_parameter_bn(cx_curve_t curve, cx_curve_dom_param_t id, cx_bn_t bn_p)
{
    cx_err_t                 error;
    cx_mpi_t                *p;
    void const              *ptr;
...
cx_err_t sys_cx_ecdomain_generator_bn(cx_curve_t curve, cx_ecpoint_t *ec_P)
{
    ...
    if ((curve != ec_P->curve) || (cx_mpi_ecpoint_from_ecpoint(&P, ec_P) != CX_OK)) {
