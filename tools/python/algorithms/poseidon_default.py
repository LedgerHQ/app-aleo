...
class PoseidonGrainLFSR():
	...
	def __init__(self, is_sbox_an_inverse, field_size_in_bits, state_len, num_full_rounds, num_partial_rounds):
...
class PoseidonDefault():
	...
	params = {'2': {'alpha' : 17, 'full_rounds' : 8, 'partial_rounds' : 31},
	...
	def find_poseidon_ark_and_mds(self):
		self.lfsr = PoseidonGrainLFSR(False, Field.MODULUS_BITS, self.rate+1, self.full_rounds, self.partial_rounds)
		ark = []
