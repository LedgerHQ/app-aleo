...
class Group:
    EDWARDS_A = BigInteger256(
        [0x8CF500000000000E, 0xE75281EF6000000E, 0x49DC37A90B0BA012, 0x55F8B2C6E710AB9]
    )
    EDWARDS_D = BigInteger256(
        [0xD047FFFFFFFF5E30, 0xF0A91026FFFF57D2, 0x9013F560D102582, 0x9FD242CA7BE5700]
    )
