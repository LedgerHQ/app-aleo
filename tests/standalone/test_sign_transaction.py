...
from application_client.response_unpacker import unpack_sign_transaction_response, unpack_get_tvk_response
...
def test_sign_transaction_transfer_batch_private_wrong_tvk(backend: BackendInterface, scenario_navigator: NavigateWithScenario) -> None:
    client = CommandSender(backend)
